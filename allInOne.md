...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/14fc3d0242b14fb0a1acf858f4c76cf7~tplv-k3u1fbpfcp-watermark.awebp)
...
1. 需求1: 定义一个一个函数得到一个数字或字符串值的字符串形式值
...
很多的第三方库都定义了对应的声明文件库, 库文件名一般为 @types/xxx, 可以在 [www.npmjs.com/package/pac…](https://link.juejin.cn?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Fpackage) 进行搜索
...
文档: [cli.vuejs.org/zh/guide/cr…](https://link.juejin.cn?target=https%3A%2F%2Fcli.vuejs.org%2Fzh%2Fguide%2Fcreating-a-project.html%23vue-create)
...
- 文档: [v3.cn.vuejs.org/guide/insta…](https://link.juejin.cn?target=https%3A%2F%2Fv3.cn.vuejs.org%2Fguide%2Finstallation.html)
...
文档:
 ...
 [composition-api.vuejs.org/zh/api.html](https://link.juejin.cn?target=https%3A%2F%2Fcomposition-api.vuejs.org%2Fzh%2Fapi.html)
...
- [developer.mozilla.org/zh-CN/docs/…](https://link.juejin.cn?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FJavaScript%2FReference%2FGlobal_Objects%2FReflect)
...
- setup的返回值
  ...
  7. setup不能是一个async函数: 因为返回值不再是return的对象, 而是promise, 模板看不到return对象中的属性数据
- setup的参数
...
![lifecycle.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c646072f639b46ea97ef1fd564c0386f~tplv-k3u1fbpfcp-watermark.awebp)

vue3的生命周期

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7c3bbfa71e814bfda6e0592df53c0646~tplv-k3u1fbpfcp-watermark.awebp)
...
1. isRef, isReactive 与 isReadonly
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ef3f4d34687c417db93a8f28bef84e2b~tplv-k3u1fbpfcp-watermark.awebp)

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d5bb89fea9e04fed8aaa7db4e16cd382~tplv-k3u1fbpfcp-watermark.awebp)

1. 使用Compisition API

我们可以更加优雅的组织我们的代码，函数。让相关功能的代码更加有序的组织在一起

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/825390a0dacf454893c23ca077e92c16~tplv-k3u1fbpfcp-watermark.awebp) ![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6f8ff6b16cd341dea749bce587903410~tplv-k3u1fbpfcp-watermark.awebp)

![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a4ad3359f61a4421bde81fc9dbee97e6~tplv-k3u1fbpfcp-watermark.awebp)
